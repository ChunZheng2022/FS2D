...
from .spconv_backbone_voxelnext_meta import VoxelResBackBone8xVoxelNeXtMeta
from .spconv_backbone_voxelnext_sps_meta import VoxelResBackBone8xVoxelNeXtSPSMeta
...
__all__ = {
    ...
    'VoxelResBackBone8xVoxelNeXtMeta': VoxelResBackBone8xVoxelNeXtMeta,
    'VoxelResBackBone8xVoxelNeXtSPSMeta': VoxelResBackBone8xVoxelNeXtSPSMeta,
}
